...
def get_schema(db):
    ...
    if isinstance(db, str):
        ...
        for item in data:
            if item['db_id'] == db_id:
                for table, v in item['tables'].items():
                    values[table] = v['header']
                    if '分类(高压母线、机端母线、厂用母线、站用母线、风光虚拟母线)' in values[table]:
                        index = values[table].index('分类(高压母线、机端母线、厂用母线、站用母线、风光虚拟母线)')
                        values[table][index] = '分类（高压母线、机端母线、厂用母线、站用母线、风光虚拟母线）'
        return values
